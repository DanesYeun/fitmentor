<div class="bg-sky-300 py-8">
    <div class="sm:m-8 lg:m-3 rounded grid grid-cols-1 sm:grid-cols-3 gap-4 flex justify-center">
        <div class="flex justify-center">
            <div class="max-w-sm rounded overflow-hidden shadow-lg bg-sky-200">
              ...
              <div class="px-6 py-4">
                ...
                <div class="flex justify-end">
                  <a href="{{ route ('staff-manager') }}" wire:navigate><x-button class="mt-5 text-black bg-transparent hover:bg-sky-300" >Manage</x-button></a>
                </div>
              </div>
            </div>
        </div>
        ...
        <div class="flex justify-center">
            <div class="max-w-sm rounded overflow-hidden shadow-lg bg-sky-200">
              ...
              <div class="px-6 py-4">
                ...
                <div class="flex justify-end">
                  <a href="{{ route ('instructor-manager') }}" wire:navigate><x-button class="mt-5 text-black bg-transparent hover:bg-sky-300" >Manage</x-button></a>
                </div>
              </div>
            </div>
        </div>
        ...
        <div class="flex justify-center">
            <div class="max-w-sm rounded overflow-hidden shadow-lg bg-sky-200">
              ...
              <div class="px-6 py-4">
                ...
                <div class="flex justify-end">
                  <a href="{{ route ('student-manager') }}" wire:navigate><x-button class="mt-5 text-black bg-transparent hover:bg-sky-300" >Manage</x-button></a>
                </div>
              </div>
            </div>
        </div>
