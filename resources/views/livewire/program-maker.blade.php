        ...
        @error('name')<span class="p-4 bg-red-500 rounded-lg text-red-800 text-lg font-semibold shadow-md flex justify-center mx-auto w-1/3">{{ $message }}</span> @enderror
                    ...
                    <form wire:submit.prevent="create" enctype="multipart/form-data">
                        ...
                        <div class="block mt-4">
                            ...
                            <x-input class="block mt-1 w-full bg-transparent text-black" type="text" placeholder="Name" wire:model="name" :value="old('name')" required />
                        </div>
                        <div class="block mt-4">
                            <x-label for="preparation" value="{{ __('Goal') }}" />
                            <textarea class="block mt-1 w-full bg-transparent text-black" row="3" placeholder="Goal" wire:model="goal" required></textarea>
                        </div>
