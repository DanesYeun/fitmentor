...
class Available extends Component
{
    ...
    public function render()
    {
        ...
        $allscheds = Schedule::where('user_id', auth()->user()->id)->where('status', 'Available')->when($this->search, function ($query) {
        ...
        return view('livewire.available', compact('exercises','allscheds'));
    }
